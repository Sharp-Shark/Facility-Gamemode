...
/cfg <arguments> - for admins to configure the mod.
	...
	commandPlayersMutatedChimera = ' is a mutated chimera.',
...
The team with more tickets respawns. In case of a tie, it's randomized.]],
	...
	mutatedChimeraInfo = 'A fast and strong monster with decent HP. Work with your fellow monsters to kill all humans! You may eat corpses, use regular doors, use the trams and use local voicechat.',
